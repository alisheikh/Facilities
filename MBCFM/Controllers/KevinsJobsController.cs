...
{
    public class KevinsJobsController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            String Subbie = "Kevin Daley";
            var incidents = db.FMIncidentsFM261.Where(s => s.SubContractor == Subbie).Where(t => t.currentStatus != "Closed").ToList();
            return View(incidents);
        }

        // GET: KevinsJobs/Details/5
        ...
        // GET: KevinsJobs/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: KevinsJobs/Create
